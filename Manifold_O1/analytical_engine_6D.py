...
class Manifold6DEngine:
    def __init__(self, mu):
        self.mu = mu
        self.lambda_opt = 10.0  # Maintained for 1:1 torsion coupling comparison
    ...
    def propagate(self, r0, v0, T, pert_params):
        """Analytical Jump to time T (Classical 6D Geometry)."""
        ...
        omega_f = omega_base  # NO relativistic shift in 6D
        ...
        # Return exact same structure as 8D engine
